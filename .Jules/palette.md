...
## 2026-04-24 - Add manual focus styles to Radix triggers
**Learning:** Custom trigger elements inside Radix UI components (using `asChild`) lose default keyboard focus styles and require manual `focus-visible` Tailwind classes to preserve accessibility.
**Action:** Always manually apply `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2` to custom trigger elements when using Radix UI components with `asChild`.
