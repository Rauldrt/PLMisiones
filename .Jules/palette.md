...
## 2026-05-07 - Missing Keyboard Focus on Radix UI Triggers
**Learning:** When using custom `button` elements as triggers inside Radix UI components with `asChild`, they lose default keyboard focus styles, making them inaccessible to keyboard users.
**Action:** Always manually apply Tailwind CSS focus utilities (e.g., `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`) and appropriate border-radius classes to custom trigger elements.
