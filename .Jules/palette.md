...
## 2026-05-12 - Trigger Button Focus States
**Learning:** Bare <button> elements used as Radix UI triggers (asChild) lose their default browser focus outline, causing keyboard navigation to become invisible. They require explicit focus-visible utilities to maintain accessibility.
**Action:** Always apply focus-visible styling (e.g., focus-visible:outline-none focus-visible:ring-2) and appropriate border radius to elements wrapping Radix UI triggers.
