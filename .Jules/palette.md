...
## 2026-04-18 - Keyboard Accessibility for Radix UI Triggers
**Learning:** When using custom button elements as triggers inside Radix UI components (like PopoverTrigger or DialogTrigger) with asChild, they lose default keyboard focus styles. This creates a critical accessibility issue for keyboard users.
**Action:** Always manually apply Tailwind CSS focus utilities (focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2) to the custom trigger elements to ensure keyboard accessibility.
