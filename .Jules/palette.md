...
## 2026-04-21 - Custom Trigger Button Keyboard Accessibility
**Learning:** When using custom `button` elements as triggers inside Radix UI components with `asChild`, they lose default keyboard focus styles, leading to inaccessible interactive elements.
**Action:** Always manually apply Tailwind CSS focus utilities (e.g., `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2`) to these custom trigger elements to ensure keyboard accessibility.
