...
## 2026-04-03 - Ambiguous link texts
**Learning:** Found 'Leer más' links in the application that provided no context for screen reader users when navigated out of context.
**Action:** Add visually hidden contextual text (using `<span className="sr-only">`) to any generic or ambiguous links to ensure accessibility for all users.
