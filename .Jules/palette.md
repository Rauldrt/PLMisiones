...
## 2026-05-23 - Focus styles for Radix custom triggers
**Learning:** When using custom button elements as triggers inside Radix UI components (like PopoverTrigger or DialogTrigger) with asChild, they lack default keyboard focus styles, causing accessibility issues for keyboard users.
**Action:** Always manually apply Tailwind CSS focus utilities (like focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2) and appropriate border-radius classes to custom trigger elements.
