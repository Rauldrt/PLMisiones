...
## 2026-04-10 - Prevent XSS via SVG uploads
**Vulnerability:** Allowed SVG file uploads in public gallery, risking Stored XSS.
**Learning:** SVGs can contain executable JavaScript code which can run in the context of the application when the file is served.
**Prevention:** Strictly exclude .svg from file upload allowed extensions.
