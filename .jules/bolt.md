...
## 2026-06-19 - Fix Invalid Global Cache Invalidation
**Learning:** In Next.js Server Actions, `revalidatePath('/*')` is invalid for global cache invalidation and can lead to unexpected caching behavior or uninvalidated paths.
**Action:** Always use `revalidatePath('/', 'layout')` to globally invalidate the entire cache tree.
