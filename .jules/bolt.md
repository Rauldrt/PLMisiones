...
## 2026-04-30 - Efficient DOM Observation
**Learning:** Continuously polling the DOM with setInterval causes main-thread blocking and layout thrashing, especially when looking for third-party embeds.
**Action:** Use a MutationObserver and check mutations.some(m => m.addedNodes.length > 0) before executing document searches, ensuring to disconnect the observer on unmount.
