...
## 2026-05-05 - Deduplicate revalidatePath calls
**Learning:** Duplicate paths in array loops trigger redundant O(N) cache invalidations causing server overhead.
**Action:** Always deduplicate paths using a Set before running revalidatePath in loops.
