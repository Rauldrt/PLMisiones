...
## 2026-04-25 - Deduplicate revalidatePath calls
**Learning:** Calling `revalidatePath` within a loop for items that might share the same path leads to redundant cache invalidation operations, causing unnecessary performance overhead.
