...
export function MosaicTile({ item, onClick }: MosaicTileProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'relative overflow-hidden rounded-3xl group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
