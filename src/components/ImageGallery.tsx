                ...
                {mediaUrls.map((url, index) => {
                    ...
                    return (
                        <button
                            ...
                            className="relative aspect-square w-full rounded-md overflow-hidden group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 bg-muted flex items-center justify-center"
                        >
                            {isImage ? (
                                <Image
                                    src={url}
