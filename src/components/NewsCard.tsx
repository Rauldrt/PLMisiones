...
export function NewsCard({ article }: { article: NewsArticle }) {
    // ⚡ Bolt: Computed derived state directly in the component body to avoid a secondary render cycle caused by useEffect.
        ...
        <Card className="flex w-full flex-col overflow-hidden bg-card border-border transition-transform hover:-translate-y-2">
            <CardHeader className="p-0">
                ...
                <div className="p-6 pb-2">
                    ...
                    {/* ⚡ Bolt: Used suppressHydrationWarning to prevent hydration mismatch for dates instead of deferring rendering with isClient */}
