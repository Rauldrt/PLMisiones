    ...
    <div className="absolute top-6 right-6 z-30">
      <Popover>
        <PopoverTrigger asChild>
          <button type="button" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-full" aria-label="Notificaciones">
            <TriggerButton />
          </button>
        </PopoverTrigger>
          ...
          <div className="space-y-2">
            {notifications.map((item, index) => (
              <NotificationDialog item={item} key={item.id}>
                <button type="button" className="w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md">
