        ...
        <PopoverContent className="w-80" align="end">
          <div className="space-y-4">
            <NotificationDialog item={latestNotification}>
              <button className="w-full text-left" aria-label={`Ver notificación: ${latestNotification.title}`}>
                ...
                <div className="space-y-2">
                  {otherNotifications.map((item) => (
                     <NotificationDialog item={item} key={item.id}>
                        <button className="w-full text-left" aria-label={`Ver notificación: ${item.title}`}>
