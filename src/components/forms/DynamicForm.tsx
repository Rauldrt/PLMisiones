...
export function DynamicForm({ formId, onSuccess }: DynamicFormProps) {
  ...
  if (loadingConfig) {
    return (
      <Card className="bg-card/90 border border-white/60 shadow-[0_25px_60px_-15px_rgba(139,31,164,0.1)] rounded-[2rem] backdrop-blur-lg w-full text-foreground p-6 min-h-[300px] flex flex-col items-center justify-center">
  ...
  if (!form) {
    return (
      <Card className="bg-card/90 border border-white/60 shadow-[0_25px_60px_-15px_rgba(139,31,164,0.1)] rounded-[2rem] backdrop-blur-lg w-full text-foreground p-6 text-center">
